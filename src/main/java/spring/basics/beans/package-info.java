 ...
 *
 *  {@link spring.basics.beans.ComplexBean} class definition demonstrates the constructor dependency technique.
 *  It has two dependencies one is a reference type and another is primitive type.
 *
 *
 * {@link spring.basics.beans.ScalarValueBean} class definition demonstrates the setter dependency injection technique.
 * All of its dependencies are scalar type (primitive type).
 *
 * @author phattall
 * @version 1.0
 * @see spring.basics.beans.ComplexBean
 * @see spring.basics.beans.ScalarValueBean
 *
 * */
